...
//go:wasmimport sonnetbox_host call
func hostCall(
	operation uint32,
...
//go:wasmexport sonnetbox_abi_version
func abiVersion() uint32 {
	return protocol.ABIVersion
}

//go:wasmexport sonnetbox_request_alloc
...
//go:wasmexport sonnetbox_evaluate
...
//go:wasmexport sonnetbox_result_ptr
...
//go:wasmexport sonnetbox_result_len
func resultLen() uint32 {
	return uint32(len(result))
}

//go:wasmexport sonnetbox_trace_ptr
...
//go:wasmexport sonnetbox_trace_len
func traceLen() uint32 {
	return uint32(len(trace))
}

//go:wasmexport sonnetbox_trace_truncated
