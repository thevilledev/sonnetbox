...
// Package main builds the embedded wasmnet WASI guest.
package main
...
//go:wasmimport wasmnet_host call
func hostCall(
	operation uint32,
...
//go:wasmexport wasmnet_abi_version
func abiVersion() uint32 {
	return protocol.ABIVersion
}

//go:wasmexport wasmnet_request_alloc
...
//go:wasmexport wasmnet_evaluate
...
//go:wasmexport wasmnet_result_ptr
...
//go:wasmexport wasmnet_result_len
func resultLen() uint32 {
	return uint32(len(result))
}

//go:wasmexport wasmnet_trace_ptr
...
//go:wasmexport wasmnet_trace_len
func traceLen() uint32 {
	return uint32(len(trace))
}

//go:wasmexport wasmnet_trace_truncated
